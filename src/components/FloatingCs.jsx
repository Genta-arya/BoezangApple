...
const FloatingCs = () => {
  return (
    <div className="fixed bottom-4 right-4 z-50">
      ...
      {/* Card */}
      <div className="absolute -left-[12rem] bottom-2 ml-4 bg-white border border-gray-300 shadow-lg rounded-lg p-2 max-w-xs dark:bg-gray-800 dark:border-gray-700">
        <h3 className="text-sm font-semibold dark:text-gray-300">Butuh Bantuan?</h3>
