          ...
          <div className="container mx-auto flex lg:flex-row md:flex-col-reverse flex-col-reverse gap-4 md:gap-4 lg:gap-24 justify-between">
            ...
            <div className="mb-8">
              ...
              <p className="mb-4 md:text-base text-sm text-justify">
                Store iPhone Pertama di Ketapang Kalimantan Barat, yang menjual
                produk iPhone second dan baru dan selain itu bisa melayani
                Service Center iPhone atau Produk Apple.
              </p>
