...
import { cn } from "@/lib/utils"; // Asumsi cn adalah utilitas yang Anda miliki

import MitraDekstop from "../MitraDekstop";

export function LampDemo() {
  return (
    <LampContainer>
      <div className="md:-mt-72 lg:-mt-20">
        <MitraDekstop />
      </div>
    </LampContainer>
  );
...
export function LampContainer({ children, className }) {
  return (
    <div
      className={cn(
        "relative flex min-h-screen flex-col  overflow-hidden bg-gray-950 w-full  z-0",
        className
      )}
    >
